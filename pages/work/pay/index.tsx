    ...
    <div className="mb-16">
      <div className="mb-16 flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-5 text-neutral-300">
          <p>
            I joined the Pay team with the goal of moving the product from an
            MVP to a fully fledged payment platform.
          </p>
          <p>
...
export const getStaticProps: GetStaticProps = () => {
  const data = workData.find((work) => work.iconName === 'pay');
